...
import { fadeUp } from "../Global-Files/animate";
        ...
        <>
            <section className=" flex  h-screen w-screen items-center justify-center bg-white ">
                <m.div
                    ...
                    initial="hidden"
                    animate="show"
                    className=" mx-5  flex h-[calc(100vh-80px)] w-full max-w-screen-sm flex-col  rounded-md bg-slate-100  shadow-lg sm:h-[500px] sm:flex-row md:mx-auto"
                >
                    ...
                    <div className="   flex h-3/5 flex-col p-4 sm:h-full sm:w-1/2 sm:justify-center sm:gap-4 ">
                        ...
                        <div className=" overflow-hidden p-2">
                            <h3>descriptions</h3>
                            <section className=" remove_scroll_bar h-full max-h-60 overflow-scroll rounded bg-gray-200 p-2 leading-8 ">
